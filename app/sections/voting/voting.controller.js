        ...
        $http.get(appConfig.urls.python_backend + "/top_proxies")
            .then(function(response) {
                ...
                angular.forEach(response.data, function(value, key) {
                    var parsed = { position: counter, account: value[0], account_name: value[1], power: value[2], followers: value[3], perc: value[4]};
                    if(counter <= 10)
                        proxies.push(parsed);
                    counter++;
                });
            ...
            .then(function(response2) {
                ...
                angular.forEach(response2.data, function (value, key) {
                    var parsed = {id: value[1], witness_account_name: value[0], proxy1: value[2].split(":")[1]
                        , proxy2: value[3].split(":")[1], proxy3: value[4].split(":")[1], proxy4: value[5].split(":")[1], proxy5: value[6].split(":")[1], proxy6: value[7].split(":")[1]
                        , proxy7: value[8].split(":")[1], proxy8: value[9].split(":")[1], proxy9: value[10].split(":")[1], proxy10: value[11].split(":")[1],
            ...
            .then(function(response2) {
                ...
                angular.forEach(response2.data, function (value, key) {
                    var parsed = {id: value[1], worker_account_name: value[0], worker_name: value[2], proxy1: value[3].split(":")[1]
                        , proxy2: value[4].split(":")[1], proxy3: value[5].split(":")[1], proxy4: value[6].split(":")[1], proxy5: value[7].split(":")[1], proxy6: value[8].split(":")[1]
                        , proxy7: value[9].split(":")[1], proxy8: value[10].split(":")[1], proxy9: value[11].split(":")[1], proxy10: value[12].split(":")[1],
