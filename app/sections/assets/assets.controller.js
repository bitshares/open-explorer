                            ...
                            .then(function(response2) {
                                ...
                                $http({
                                    ...
                                    $scope.data = {
                                        ...
                                        max_supply: response.data[0].options.max_supply/Math.pow(10, response.data[0].precision),
                                        issuer: response.data[0].issuer,
                                        precision: response.data[0].precision,
                                        current_supply: response.data[0].current_supply/Math.pow(10, response.data[0].precision),
                                        confidential_supply: response.data[0].confidential_supply/Math.pow(10, response.data[0].precision),
                                        holders: response2.data,
                                        issuer_name: response.data[0].issuer_name,
                                        accumulated_fees: response.data[0].accumulated_fees/Math.pow(10, response.data[0].precision),
                                        fee_pool: response.data[0].fee_pool/Math.pow(10, response.data[0].precision),
                                        type: type,
                                        image_url: image_url,
                                    ...
                                    $scope.data = {
                                        ...
                                        description: description,
                                        long_description: long_description,
                                        max_supply: response.data[0].options.max_supply,
                                        issuer: response.data[0].issuer,
                                        precision: response.data[0].precision,
                                        current_supply: response.data[0].current_supply/Math.pow(10, response.data[0].precision),
                                        confidential_supply: response.data[0].confidential_supply/Math.pow(10, response.data[0].precision),
                                        holders: response2.data,
                                        issuer_name: response.data[0].issuer_name,
                                        accumulated_fees: response.data[0].accumulated_fees,
                                        fee_pool: response.data[0].fee_pool,
                                        type: type,
                                        image_url: image_url,
                                        volume: parseInt(response.data[0].volume),
                                        market_cap: response.data[0].mcap/100000
